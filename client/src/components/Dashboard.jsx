...
const Dashboard = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setTotalExpense(summaryRes.totalExpenses || 0);
  ...
  return (
    <Layout>
      <div
        ...
        bg-gradient-to-b from-slate-50 to-white dark:from-[#0c0f1c] dark:to-[#1a1d2e] text-slate-800 dark:text-white rounded-3xl shadow-xl`}
      >
        {/* Header */}
