    ...
    >
      ...
      >
        ...
        <div className="flex flex-row items-center py-[6px] px-4 bg-[rgba(0,246,255,0.1)] dark:bg-[rgba(0,246,255,0.2)] rounded-[10px] mb-2">
          <p
            className={`${styles.paragraph} ml-2 text-gray-900 dark:text-gray-100`}
          >
        ...
        <p
          className={`${styles.paragraph} max-w-[470px] mt-5 text-neutral-700 dark:text-dimWhite`}
        >
          Manage your budgets, set spending goals, and stay financially aware
          with a smart and intuitive dashboard. All in real-time.
        </p>
      </div>
